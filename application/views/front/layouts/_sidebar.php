<div class="col-lg-4">
   <div class="right_sidebar">
      ...
      <aside class="r_widgets social_widgets mt-5">
         ...
         <ul class="list">
            <li><a href="#"><i class="fa fa-facebook"></i>Web-Genius<span>Like our page</span></a></li>
            <li><a href="#"><i class="fa fa-twitter"></i>Web-Genius<span>Follow Us</span></a></li>
            <li><a href="#"><i class="fa fa-youtube-play"></i>Web-Genius<span>Subscribe</span></a></li>
         </ul>
      </aside>
