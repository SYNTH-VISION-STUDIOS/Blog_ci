<ul class="navbar-nav bg-gradient-orange-black sidebar sidebar-dark accordion" id="accordionSidebar">
   <style>
      .bg-gradient-orange-black {
    background: linear-gradient(to bottom, #FF0000FF, #FFAE00FF);
    color: #000;
}
</style>
   <!-- Sidebar - Brand -->
   <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= base_url('admin') ?>">
      ...
      <div class="sidebar-brand-text mx-1">Admin <br> Web-Genius</div>
   </a>
